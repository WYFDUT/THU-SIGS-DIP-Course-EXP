...
parser.add_argument('--datatype', default='2015',
                    help='datapath')
parser.add_argument('--datapath', default='/root/wyf/Experiment-8/Experiment-8/data_scene_flow_2015/training/',
                    help='datapath')
parser.add_argument('--epochs', type=int, default=300,
                    help='number of epochs to train')
parser.add_argument('--loadmodel', default=None,
                    help='load model')
parser.add_argument('--savemodel', default='./save_models_3/',
                    help='save model')
...
def main():
    ...
    writer = SummaryWriter(log_dir='runs_3')
    ...
    for epoch in range(1, args.epochs+1):
        ...
        writer.add_scalar(tag="training loss", 
                            scalar_value=total_train_loss/len(TrainImgLoader),  
                            global_step=epoch  
                         )
        ...
        writer.add_scalar(tag="total 3-px error in val", 
                            scalar_value=total_test_loss/len(TestImgLoader)*100,  
                            global_step=epoch  
                         )
