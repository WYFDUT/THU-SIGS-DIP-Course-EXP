...
if __name__ == '__main__':
    ...
    parser.add_argument('--det-weights', nargs='+', type=str, default='/root/wyf/Violation_Detect/License_recognition/YOLOv5-LPRNet-Licence-Recognition-master/weights/yolov5_best.pt', help='model.pt path(s)')
    parser.add_argument('--rec-weights', nargs='+', type=str, default='/root/wyf/Violation_Detect/License_recognition/YOLOv5-LPRNet-Licence-Recognition-master/weights/lprnet_best.pth', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='/root/wyf/Violation_Detect/License_recognition/YOLOv5-LPRNet-Licence-Recognition-master/demo/images', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--output', type=str, default='/root/wyf/Violation_Detect/License_recognition/YOLOv5-LPRNet-Licence-Recognition-master/demo/rec_result', help='rec_result folder')  # rec_result folder
