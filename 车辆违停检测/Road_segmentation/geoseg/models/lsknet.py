...
@register_model
def lsknet_b0(pretrained=False, **kwargs):
    model = LSKNet(
    ...
    if pretrained:
        model = load_model_weights(model, "lsknet_b0", kwargs)
    return model


@register_model
def lsknet_b1(pretrained=False, **kwargs):
    model = LSKNet(
    ...
    model.default_cfg = _cfg()
    if pretrained:
        model = load_model_weights(model, "lsknet_b1", kwargs)
    return model

@register_model
def lsknet_b2(pretrained=False, **kwargs):
    model = LSKNet(
        embed_dims=[64, 128, 320, 512], mlp_ratios=[8, 8, 4, 4],
    ...
    model.default_cfg = _cfg()
    if pretrained:
        model = load_model_weights(model, "lsknet_b2", kwargs)
    return model

@register_model
def lsknet_b3(pretrained=False, **kwargs):
    model = LSKNet(
        embed_dims=[64, 128, 320, 512], mlp_ratios=[8, 8, 4, 4],
    ...
    model.default_cfg = _cfg()
    if pretrained:
        model = load_model_weights(model, "lsknet_b3", kwargs)
    return model

@register_model
def lsknet_b4(pretrained=False, **kwargs):
    model = LSKNet(
        embed_dims=[64, 128, 320, 512], mlp_ratios=[8, 8, 4, 4],
    ...
    model.default_cfg = _cfg()
    if pretrained:
        model = load_model_weights(model, "lsknet_b4", kwargs)
    return model


@register_model
def lsknet_b5(pretrained=False, **kwargs):
    model = LSKNet(
    ...
    model.default_cfg = _cfg()
    if pretrained:
        model = load_model_weights(model, "lsknet_b5", kwargs)
    return model


@register_model
def lsknet_b6(pretrained=False, **kwargs):
    model = LSKNet(
    ...
    model.default_cfg = _cfg()
    if pretrained:
        model = load_model_weights(model, "lsknet_b6", kwargs)
    return model
