...
class UnetFormerLoss(nn.Module):
    ...
    def __init__(self, ignore_index=255):
        ...
        self.main_loss = JointLoss(self.main_loss,
                                   nn.CrossEntropyLoss(weight=torch.tensor([5.0, 1.0]), size_average=None,
                                                        ignore_index=ignore_index, reduce=None, reduction='mean'), 0.5, 0.5)
