...
weights_name = "unetformer-lsk_s-1024-768crop-e40"
...
train_dataset = UAVIDDataset(data_root='/root/wyf/airs/data/uavid/train_val', img_dir='images', mask_dir='masks',
                             mode='train', mosaic_ratio=0.25, transform=train_aug, img_size=(1024, 1024))

val_dataset = UAVIDDataset(data_root='/root/wyf/airs/data/uavid/val', img_dir='images', mask_dir='masks', mode='val',
