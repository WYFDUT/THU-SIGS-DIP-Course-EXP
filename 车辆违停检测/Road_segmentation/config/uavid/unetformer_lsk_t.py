...
weights_name = "unetformer-lsk_t-1024-768crop-e40"
...
train_dataset = UAVIDDataset(data_root='/root/siton-gpfs-pubdata/remote_sense/UAVid/train_val', img_dir='images', mask_dir='masks',
                             mode='train', mosaic_ratio=0.25, transform=train_aug, img_size=(1024, 1024))

val_dataset = UAVIDDataset(data_root='/root/siton-gpfs-pubdata/remote_sense/UAVid/val', img_dir='images', mask_dir='masks', mode='val',
