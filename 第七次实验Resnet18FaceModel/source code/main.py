...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', type=str, default='/root/wyf/Experiment-7/center-loss/log',
                        help='log directory')
    ...
    parser.add_argument('--resume', type=str,
                        ...
                        default=False)
    parser.add_argument('--dataset_dir', type=str, default='/root/wyf/Experiment-7/center-loss/dataset',
