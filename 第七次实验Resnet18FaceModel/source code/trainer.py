...
class Trainer(object):
    ...
    def __init__(
            ...
            persist_stride=5, lamda=0.1, alpha=0.5):
    ...
    def run_epoch(self, mode):
        ...
        with torch.set_grad_enabled(mode == 'train'):
            for images, targets, names in dataloader:
                ...
                # YOUR CODE HERE. 计算交叉熵损失，变量名设为'cross_entropy_loss'
                cross_entropy_loss = F.cross_entropy(logits, targets, ignore_index=-100, reduce=None, reduction='mean')
                # YOUR CODE HERE. 计算总损失，变量名设为'loss'
